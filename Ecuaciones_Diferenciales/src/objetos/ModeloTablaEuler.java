 ...
 * @author PACO
 */
public class ModeloTablaEuler extends AbstractTableModel{
    
    private ArrayList<Columnas_tabla> filas;
    private ArrayList<String> iteraciones;

    public ModeloTablaEuler() {
    }

    public ModeloTablaEuler(ArrayList<Columnas_tabla> filas, ArrayList<String> iteraciones) {
        this.filas = filas;
