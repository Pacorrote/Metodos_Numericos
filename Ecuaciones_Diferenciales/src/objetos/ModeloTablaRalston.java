 ...
 * @author PACO
 */
public class ModeloTablaRalston extends AbstractTableModel{
    private ArrayList<Columnas_tabla> filas;
    private ArrayList<String> iteraciones;

    public ModeloTablaRalston() {
    }

    public ModeloTablaRalston(ArrayList<Columnas_tabla> filas, ArrayList<String> iteraciones) {
        this.filas = filas;
